...
func TestCreateECDSAKeyPair(t *testing.T) {
	privKey, pubKey, cpubKey, _ := ecdsaSigner.CreateKeyPair()
...
func TestSignMessage(t *testing.T) {
	...
	signature, err := ecdsaSigner.SignMessage(privKey, message)
	if err != nil {
...
func TestVerifyEcdsaSignature(t *testing.T) {
	...
	isValid, err := ecdsaSigner.VerifySignature(CompressedPubKey, txHash, signature)
	if err != nil {
