...
contract TreasureManagerScript is Script {
    ...
    function run() public {
        ...
        TransparentUpgradeableProxy proxyTheWebThree = new TransparentUpgradeableProxy(
        ...
        theWebThreeProxyAdmin = ProxyAdmin(
            getProxyAdminAddress(address(proxyTheWebThree))
        );
        ...
        console2.log("Transparent Proxy deployed at:", address(theWebThree));
        vm.stopBroadcast();
    }
 ...
 * 
 * == Logs ==
  theWebThree address====== 0x05b88A18B699c43E7876bE733B98400542e1C286
  Transparent Proxy deployed at: 0x05b88A18B699c43E7876bE733B98400542e1C286
 */
